        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-2 text-sm text-gray-300">
              <div className="flex items-center">
                ...
                <span> 7-C commercial area sector market Pak Arab housing society Lahore Pakistan</span>
              </div>
              <div className="flex items-center">
                <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20">
                ...
                <span>unanimouscommunications89@gmail.com</span>
              </div>
              {/* <div className="flex items-center">
                <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                </svg>
                <span>04237137107</span>
              </div> */}
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/terms-conditions" className="text-gray-300 hover:text-white transition-colors duration-200">
          ...
          <div>
            ...
            <div className="text-gray-300">
              <p className="mb-2">24/7, Monday - Sunday</p>
              <p className="text-sm">
